...
---
DevOps is a term that has been around for some years now. We understand DevOps as a philosophy and culture with related practices and ui-and-devices - all with the aim of bringing (IT) Operations closer to Development.  
...
**Increase of relevant ui-and-devices**
...
**DevSetup = Prod Setup, [Infrastructure as a Code](infrastructure-and-operational-technology/infrastructure-as-code.html)**
