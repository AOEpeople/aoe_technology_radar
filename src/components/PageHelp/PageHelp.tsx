  ...
  return (
    <Fadeable leaving={leaving} onLeave={onLeave}>
      ...
      <h3>Introduction</h3>
        ...
        <p>It's essential for a development and technology company such as Volvofinans to constantly improve and keep track with the latest useful innovations.
        ...
        <ul>
          <li><strong>Languages and Frameworks:</strong> We've placed development languages (such as Java or .NET Core) here, as well as more low-level development frameworks (such as Play or Symfony), which are useful for implementing custom software of all kinds. </li>
          ...
          <li><strong>Platforms and Services</strong> Here we include infrastructure platforms and services. We also use this category to communicate news about Volvofinans services that we want all Volvofinans teams to be aware of.</li>
        </ul>
        <p>Each of the items is classified in one of these rings:</p>
        <ul>
          <li><strong>Emerging:</strong> Technology that is new to Volvofinans Bank but likely can bring benefits/improvements, Technology under evaluation/Proof of Concept - candidate for being "Appointed". Building knowledge and eventually infrastructure/platform services.</li>
          <li><strong>Appointed:</strong> Known and used Technologies at Volvofinans Bank. Technology to use in new implementations.</li>
          <li><strong>Preserving:</strong> Technology used at Volvofinans but not really wanted. No or Limited new implementations using this technology.</li>
          <li><strong>Sunset:</strong> Technology that will be removed from Volvofinans and have a time plan to do so. No new implementations.</li>
        </ul>
      </div>
    </Fadeable>
  );
