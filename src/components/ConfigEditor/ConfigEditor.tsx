...
const schema = Yup.object().shape({
  ...
  scale1: Yup.number().required("Scale 1 is required"),
  scale2: Yup.number().required("Scale 2 is required"),
  blipsize: Yup.number().required("Blip Size is required"),
  quadKey1: Yup.string().required("Quadrant 1 is required"),
  quadKey2: Yup.string().required("Quadrant 2 is required"),
  quadKey3: Yup.string().required("Quadrant 3 is required"),
  quadKey4: Yup.string().required("Quadrant 4 is required"),
  qmap1Key3: Yup.number()
    .required("Quadrant 1 Position is required")
    .max(4)
    .min(1),
  qmap1Key4: Yup.string().required("Quadrant 1 Description is required"),

  qmap2Key3: Yup.number()
    .required("Quadrant 2 Position is required")
    .max(4)
    .min(1),
  qmap2Key4: Yup.string().required("Quadrant 2 Description is required"),
  qmap3Key3: Yup.number()
    .required("Quadrant 3 Position is required")
    .max(4)
    .min(1),
  qmap3Key4: Yup.string().required("Quadrant 3 Description is required"),
  qmap4Key3: Yup.number()
    .required("Quadrant 4 Position is required")
    .max(4)
    .min(1),
  qmap4Key4: Yup.string().required("Quadrant 4 Description is required"),
  key1: Yup.string().required("Ring 1 is required"),
  key2: Yup.string().required("Ring 2 is required"),
  key3: Yup.string().required("Ring 3 is required"),
  key4: Yup.string().required("Ring 4 is required"),

  ringKey1radius: Yup.number().required("Ring 1 Radius is required"),
  ringKey1arc: Yup.number().required("Ring 1 Arc Width is required"),

  ringKey2radius: Yup.number().required("Ring 2 Radius is required"),
  ringKey2arc: Yup.number().required("Ring 2 Arc Width is required"),

  ringKey3radius: Yup.number().required("Ring 3 Radius is required"),
  ringKey3arc: Yup.number().required("Ring 3 Arc Width is required"),

  ringKey4radius: Yup.number().required("Ring 4 Radius is required"),
  ringKey4arc: Yup.number().required("Ring 4 Arc Width is required"),
...
const ConfigEditor: React.FC = () => {
  ...
  const initialValues = {
    ...
    quadKey2:
      config?.quadrants["methods-and-patterns"] || "methods-and-patterns",
    quadKey3:
    ...
    qmap1Key1:
      config?.quadrantsMap["languages-and-frameworks"].colour || "#84BFA4",
    qmap1Key2:
      config?.quadrantsMap["languages-and-frameworks"].txtColour || "#444444",
    qmap1Key3: config?.quadrantsMap["languages-and-frameworks"].position || 1,
    qmap1Key4:
      config?.quadrantsMap["languages-and-frameworks"].description || "",

    // Quadrants Map - Quadrant 2
    qmap2Key1: config?.quadrantsMap["methods-and-patterns"].colour || "#248EA6",
    qmap2Key2:
      config?.quadrantsMap["methods-and-patterns"].txtColour || "#FFFFFF",
    ...
    qmap3Key1:
      config?.quadrantsMap["platforms-and-aoe-services"].colour || "#F25244",
    qmap3Key2:
      config?.quadrantsMap["platforms-and-aoe-services"].txtColour || "#444444",
    qmap3Key3: config?.quadrantsMap["platforms-and-aoe-services"].position || 3,
    qmap3Key4:
      config?.quadrantsMap["platforms-and-aoe-services"].description || "",
    ...
    >
      {({ errors, touched }) => (
        <Form className="form-container">
          ...
          <div className="form-group">
            <label htmlFor="quadKey1">
              {" "}
              Quadrant-1 Languages-and-Frameworks:
            </label>
          ...
          <div className="form-group">
            <label htmlFor="quadKey3">
              Quadrant-3 Platforms-and-AOE-services:
            </label>
          ...
          <div className="section-title">
            ...
            <div>
              ...
              <div className="form-group">
                ...
                <Field type="color" id="qmap1Key2" name="qmap1Key2" />
                <ErrorMessage
                  name="qmap1Key2"
                  component="div"
                  className="error-message"
              ...
              <div className="form-group">
                ...
                <Field type="text" id="qmap1Key3" name="qmap1Key3" />
                <ErrorMessage
                  name="qmap1Key3"
                  component="div"
                  className="error-message"
              ...
              <div className="form-group">
                ...
                <Field type="text" id="qmap1Key4" name="qmap1Key4" />
                <ErrorMessage
                  name="qmap1Key4"
                  component="div"
                  className="error-message"
          ...
          <div>
            ...
            <div className="form-group">
              ...
              <Field type="color" id="qmap3Key2" name="qmap3Key2" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <Field type="text" id="qmap3Key4" name="qmap3Key4" />
              <ErrorMessage
                name="qmap3Key4"
                component="div"
                className="error-message"
