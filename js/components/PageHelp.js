    ...
    <Fadeable leaving={leaving} onLeave={onLeave}>
      ...
      <div className="fullpage-content">
        ...
        <ul>
          ...
          <li><strong>Hold:</strong> This category is a bit special. Unlike the others, we recommend to stop doing or using something. We move things here if we think we shouldn't do or use them (anymore).</li>
        </ul>
